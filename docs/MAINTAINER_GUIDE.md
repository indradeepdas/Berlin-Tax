...
- `npm run sources:dashboard:write` refreshed `docs/SOURCE_DASHBOARD.md` on the release day.
- `npm run beta:check` passes before public beta release.
...
4. Run `npm run sources:dashboard:write`.
5. Run `npm run beta:check`.
